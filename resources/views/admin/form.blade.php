                        ...
                        @if($cfg['key'] === 'products' && $editing && $name === 'thumbnail')
                            <div style="margin-top:10px">
                                <button type="button" class="abtn abtn-ghost abtn-sm" id="imgAutoBtn"
                                        ...
                                        data-fetch="{{ route('admin.products.imagefetch', $item->id) }}">🔍 이미지 자동검색 (수입과일몰·네이버)</button>
                                ...
                                <div style="margin-top:10px;display:flex;gap:6px">
                                    <input type="url" id="imgUrlInput" class="ainput" placeholder="또는 이미지 URL·상품페이지 URL 붙여넣기 (쿠팡/수입과일몰 등)"
